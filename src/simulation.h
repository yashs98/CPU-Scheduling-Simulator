...
private:
    ...
    double systemThreads;
    double interactiveThreads;
    double normalThreads;
    double batchThreads;


    double systemResponseTime = 0.0;
    double interactiveResponseTime = 0.0;
    double batchResponseTime = 0.0;
    double normalResponseTime = 0.0;

    double systemTAT = 0.0;
    double interactiveTAT = 0.0;
    double batchTAT = 0.0;
    double normalTAT = 0.0;
